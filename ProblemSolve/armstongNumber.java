...
public class armstongNumber {
    public static void main(String[] args) {
        ...
        while (temp != 0) {
            ...
            sum = sum + r*r*r; // 0 = 0 + 3(r) => 3         // 3 = 3 + 2(r) = 5   // 5 = 5 + 1(r) => 6
            temp = temp / 10; // temp = 123 / 10 => 12 // temp = 12/ 10 => 1 // temp = 1 / 10 => 0 
        }
        if(num == sum)
        {
            System.out.println("This is Armstong Number : "+num);
            
        }
        else
        {
            System.out.println("This is Not Armstong Number : "+num);
        }
        System.out.println("Because Sum is : "+sum);
        input.close();
    }
}
